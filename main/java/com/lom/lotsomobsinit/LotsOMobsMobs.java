...
//Temporary fix for missing vanilla creature spawn:
        ...
        EntityRegistry.addSpawn(EntityHorse.class, 20, 1, 4, EnumCreatureType.creature, new BiomeGenBase[] {BiomeGenBase.plains});
				...
				{  
					...
					EntityRegistry.addSpawn(EntityHermitCrab.class, (int)ConfigHandler.HermitCrabRate *10, 2, 6, EnumCreatureType.creature, new BiomeGenBase[] {BiomeGenBase.beach, BiomeGenBase.ocean/*, LotsOMobs.modBiomeTropicBeach*/});
				...
				{    
			        ...
			        EntityRegistry.addSpawn(EntityTropicalFishy.class, (int)ConfigHandler.FishyRate *10, 5, 15, EnumCreatureType.waterCreature, new BiomeGenBase[] {/*LotsOMobs.modBiomeTropicBeach*/});
			    }
